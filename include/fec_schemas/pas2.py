"""FEC Contributions to Candidates (pas2) schema.

Source: Schedule B filings — contributions from PACs and other committees
directly to candidate committees (transaction types 24K, 24E, etc.).
FEC bulk download: ``pas2{yy}.zip`` containing ``itpas2.txt``.
"""
